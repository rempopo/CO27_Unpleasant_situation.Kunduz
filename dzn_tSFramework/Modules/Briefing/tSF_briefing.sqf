...
<br />Если игроки решат вызвать вертокрыла, до зачистки хотя бы первого обжектива, помоги инсургентам сбить его, если у них не получится самостоятельно (в зоне операции 4 пацана с АА).
